...
/**
 * Soft-delete a job profile within an organization. Verifies the job profile belongs to the org and that the requester is an admin of that org.
 */
export const apiOrganizationsJobProfilesDeleteDelete = <ThrowOnError extends boolean = true>(options: Options<ApiOrganizationsJobProfilesDeleteDeleteData, ThrowOnError>) => (options.client ?? client).delete<ApiOrganizationsJobProfilesDeleteDeleteResponses, ApiOrganizationsJobProfilesDeleteDeleteErrors, ThrowOnError>({
    responseType: 'json',
    security: [{ name: 'Authorization', type: 'apiKey' }],
 ...
 *
 */
export const apiOrganizationsJobProfilesApplicationsBulkCreate = <ThrowOnError extends boolean = true>(options: Options<ApiOrganizationsJobProfilesApplicationsBulkCreateData, ThrowOnError>) => (options.client ?? client).post<ApiOrganizationsJobProfilesApplicationsBulkCreateResponses, ApiOrganizationsJobProfilesApplicationsBulkCreateErrors, ThrowOnError>({
    ...formDataBodySerializer,
    responseType: 'json',
    security: [{ name: 'Authorization', type: 'apiKey' }],
...
/**
 * Update a member's role. Only org admins can do this. Cannot demote the last admin.
 */
export const apiOrganizationsMembersRolePartialUpdate = <ThrowOnError extends boolean = true>(options: Options<ApiOrganizationsMembersRolePartialUpdateData, ThrowOnError>) => (options.client ?? client).patch<ApiOrganizationsMembersRolePartialUpdateResponses, ApiOrganizationsMembersRolePartialUpdateErrors, ThrowOnError>({
    responseType: 'json',
    security: [{ name: 'Authorization', type: 'apiKey' }],
