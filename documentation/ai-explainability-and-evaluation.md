...
The system will be evaluated through structured testing with HR practitioners. Participants will review AI-generated classifications for a set of standardised test cases and complete a validated evaluation instrument. The design follows accepted human-computer interaction and information systems research practice.

### 7.2 Evaluation Instrument

**System Usability Scale (SUS)** — The primary instrument is the System Usability Scale (Brooke, 1996), a 10-item Likert-scale questionnaire with established validity and reliability across diverse system types. It produces a composite score (0–100) interpreted against established norms:
...
**Domain-specific supplementary items** will assess:
- Perceived accuracy of the classification relative to the reviewer's own judgment
- Clarity and adequacy of the AI's justification
- Usefulness of the output as a decision-support aid
- Trust and confidence in the system's recommendations

If supplementary items are used as a composite scale, **Cronbach's alpha (α)** will be computed to verify internal consistency reliability. The accepted threshold is α ≥ 0.70 (Nunnally, 1978).

### 7.3 Classification Accuracy

To measure whether the AI's classification aligns with expert human judgment:

1. Each participating HR reviewer will independently classify the same set of test candidates against the same job profile, without seeing the AI's classification first.
2. The AI classification will then be compared to the reviewer's classification.
3. **Agreement rate** (percentage of cases where AI and reviewer produce the same category) will be computed.
4. **Cohen's Kappa (κ)** — a statistical measure of inter-rater agreement corrected for chance — will be computed for ordinal categories. Interpretation follows Landis & Koch (1977): κ ≥ 0.61 is considered substantial agreement; κ ≥ 0.81 is considered almost perfect.

### 7.4 Reporting Standards

All results will be reported as:
- **Mean (M)** and **standard deviation (SD)** for all scale scores
- **SUS composite score** with interpretation against published norms
- **Agreement rate** and **Cohen's Kappa** for classification accuracy analysis
- Item-level means to identify specific dimensions of strength or weakness

Results will not be selectively reported. If the system performs below acceptable thresholds on any dimension, the specific issue will be identified, corrective action will be taken, and a re-evaluation will be conducted.

### 7.5 Ethical Considerations

- All participants will provide informed consent before participation
- Participants will be informed that their responses contribute to academic research
- No evaluation data will be manipulated or selectively omitted
- Resume data used in testing will be anonymised or synthetic to protect individual privacy
- The principle of **research integrity** is observed: results are reported as observed, whether they support or challenge the system's claimed effectiveness

---

## 8. Development Methodology and Timeline

This project follows the **Waterfall software development methodology** — a sequential, phase-gated process in which each phase is completed before the next begins:

```
Requirements Analysis → System Design → Implementation → Testing and Evaluation → Defense
```

Waterfall was selected because the system requirements were defined upfront, the scope is bounded and well-understood, and the academic timeline requires predictable milestone delivery rather than iterative cycles.

| Phase | Target |
|-------|--------|
| System implementation complete | April 2026 |
| Internal functional testing | April 2026 |
| HR practitioner evaluation sessions | April 2026 |
| Quantitative analysis of evaluation results | Late April 2026 |
| System refinement (if indicated by results) | Late April 2026 |
| Final documentation and presentation | Late April – Early May 2026 |
...
- Brooke, J. (1996). SUS: A "quick and dirty" usability scale. In P. Jordan, B. Thomas, B. Weerdmeester, & A. McClelland (Eds.), *Usability Evaluation in Industry*. Taylor & Francis.
